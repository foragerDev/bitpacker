...
{
    std::vector<std::byte> bytes{static_cast<std::byte>(0x1F), static_cast<std::byte>(0x1B)};
...
{
    const std::vector<std::byte> bytes{static_cast<std::byte>(0x1F), static_cast<std::byte>(0x1B)};
